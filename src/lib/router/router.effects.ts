...
export class RouterEffects {
  ...
  navigate$: Observable<RouterNavigateAction> = this.actions$
    .pipe(
      ...
      tap((a: RouterNavigateAction) => this.router.navigate(a.params.commands, a.params.extras))
    );
  ...
  navigateByUrl$: Observable<RouterNavigateByUrlAction> = this.actions$
    .pipe(
      ...
      tap((a: RouterNavigateByUrlAction) => this.router.navigateByUrl(a.params.url, a.params.extras))
    );
